...
public class WorkFlowServiceImpl implements IWorkFlowService {
    ...
    public void initiateSubmissionWorkFlow(WorkFlowRequestTO requestTO) throws WorkFlowException {
        ...
        if (iNextGroup != null) {
            ...
            notificationService.sendNotificationOnStatusChangeForHP(workFlow.getApplicationType().getName(),workFlow.getAction().getName(),workFlow.getHpProfile().getEmailId(),workFlow.getHpProfile().getMobileNumber());
    ...
    public void initiateCollegeRegistrationWorkFlow(String requestId, BigInteger applicationTypeId, BigInteger actorId, BigInteger actionId) throws WorkFlowException {
        ...
        if (iNextGroup != null) {
            ...
            notificationService.sendNotificationOnStatusChangeForCollege(workFlow.getApplicationType().getName(),workFlow.getAction().getName(),workFlow.getHpProfile().getEmailId(),workFlow.getHpProfile().getMobileNumber());
