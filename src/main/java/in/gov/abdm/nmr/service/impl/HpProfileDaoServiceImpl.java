...
//			currentAddressTO.setUpdatedDate(currentAddress.get("updated_date", String.class));
    ...
    public HpProfileUpdateResponseTO updateHpProfile(BigInteger hpProfileId,
        ...
        if ((hpProfileUpdateRequest.getPersonalDetails().getSalutation() != null
            ...
            if (iHpProfileRepository.existsById(hpProfileId) == true) {
                ...
                //eSign_change
                hpProfile.setTransactionId(hpProfileUpdateRequest.getTransactionId());
                hpProfile.setESignStatus(hpProfileUpdateRequest.getESignStatus());
    ...
    public HpProfileAddResponseTO addHpProfile(HpProfileAddRequestTO hpProfileAddRequest, String requestId)
        ...
        if ((hpProfileAddRequest.getPersonalDetails().getSalutation() != null
            ...
            //eSign_change
            hpProfile.setTransactionId(hpProfileAddRequest.getTransactionId());
            hpProfile.setESignStatus(hpProfileAddRequest.getESignStatus());
