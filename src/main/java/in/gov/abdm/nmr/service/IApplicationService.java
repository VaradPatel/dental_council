...
public interface IApplicationService {
     ...
     * @throws WorkFlowException if there is any error while processing the suspension request.
     */
    ReactivateRequestResponseTo reactivateRequest(MultipartFile reactivationFile, ApplicationRequestTo applicationRequestTo) throws WorkFlowException, NmrException, InvalidRequestException, IOException, InvalidFileUploadException;
