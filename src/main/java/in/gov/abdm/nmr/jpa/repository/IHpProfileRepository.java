...
//			+ " LEFT JOIN qualification_status on qualification_status.id = qualification_status "
    ...
    List<HpProfile> findHpProfileByRegistrationId(String registrationId);
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE hp_profile SET email_id =:email  WHERE id =:hpProfileId", nativeQuery = true)
    void updateHpProfileEmail(BigInteger hpProfileId, String email);
