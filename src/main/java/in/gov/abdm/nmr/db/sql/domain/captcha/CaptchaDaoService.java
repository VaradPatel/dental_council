...
@Service
@Transactional
public class CaptchaDaoService implements ICaptchaDaoService {

    private ICaptchaRepository captchaRepository;
    
    private boolean captchaEnabled;

    public CaptchaDaoService(ICaptchaRepository captchaRepository, @Value("${nmr.captcha.enabled}") boolean captchaEnabled) {
